...
{
	public class WitchsPot : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			name.SetDefault("Witch's Pot");
			AddMapEntry(new Color(200, 200, 200), name, MapChestName);

			AdjTiles = new int[] { TileID.Containers };
			ContainerName.SetDefault("Witch's Pot");
			ChestDrop = ModContent.ItemType<Items.WitchsPot>();
		}
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
				player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Witch's Pot";
				if (player.cursorItemIconText == "Witch's Pot")
				{
					player.cursorItemIconID = ModContent.ItemType<Items.WitchsPot>();
